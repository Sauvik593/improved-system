...
export const MobileTrigger = ({ onModalOpen, label }: Props) => (
  ...
  >
    <Search className="text-ocean-100 pointer-events-none absolute left-2 top-1/2 m-auto -translate-y-1/2 transform" />
    <div
      className={cn(
        'text-sierra-night-100 rounded-md bg-white p-2',
        'placeholder:text-sierra-night-40 w-full pl-10',
      )}
    >
