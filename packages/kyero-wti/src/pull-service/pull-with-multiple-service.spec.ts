import { PullWithMultipleService } from './pull-with-multiple-service';
    ...
    describe("when it's valid", () => {
      ...
      it('should call the downloader and filesWriter', async () => {
        ...
        const filesWriterMock = {
          callWithMultiple: vi.fn(),
        };
        const pullService = new PullWithMultipleService();
        ...
        expect(filesWriterMock.callWithMultiple).toHaveBeenCalledWith('files');
      });
    });
